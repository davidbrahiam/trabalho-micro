...
{	
// declarar um contador: variavel de controle do duty cycle 
int cont = 0;    
Inic_Regs ();           // Inicializa o SFRs
Confg_PWM ();           // Configura e inicializa o PWM com duty cycle d5 50%
Config_Duty_Cycle(00);  // Ajusta o Duty Cycle (%) 

// Modo reverso do motor: anti-horário
//PORTCbits.RC0 = 0;
//PORTCbits.RC1 = 1;

// Modo forward (para frente): horário
PORTCbits.RC0 = 1;
PORTCbits.RC1 = 0;
